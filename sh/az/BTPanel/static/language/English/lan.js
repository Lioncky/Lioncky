var lan = {
	...
	"site":{
		...
		"anti_XSS_attack":"反XSS攻击(open_basedir)",
		...
		"limit_net_10": "并发限制",
		"limit_net_11": "最大并发限制",
		"limit_net_12": "阻止单一 IP",
		"limit_net_13": "单一 IP 访问最大并发限制",
		"limit_net_14": "流量控制",
		...
		"proxy_url": "目标URL",
		"proxy_url_info": "请使用完整 URL，例如：http://www.test.com",
		"proxy_domain": "发送域名",
		"proxy_domian_info": "发送到目标服务器的域名，例如：www.test.com",
		"proxy_cache": "启用缓存",
		"con_rep": "内容替换",
		"con_rep_info": "源文本",
		"to_con": "替换为(可空)",
		"proxy_enable": "启用反向代理",
		"proxy_help_1": "目标 URL 必须是可访问的，否则会直接返回 502 错误代码。",
		"proxy_help_2": "默认情况下，此站点上的所有域名都将传递到目标服务器，请确保目标服务器已绑定域名。",
		"proxy_help_3": "如果您的站点是被动代理，请在发送的域名中填写目标站点的域名。",
		"proxy_help_4": "如果不需要内容替换功能，请留空。",
		"proxy_help_5":"您可以通过清除来清除缓存, e.g., http://test.com/purge/test.png",
		"access_domain": "访问域名",
		"all_site": "整个站点",
		"target_url":"目标URL",
		"eg_url":"请使用完整URL, 例如: http://www.test.com",
		"enable_301":"启用 301",
		"to301_help_1": "如果选择整个站点,请不要将目标 URL 设置为同一站点中的域名",
		"to301_help_2": "取消 301 跳转后,您需要清除浏览器缓存才能看到结果",
		"bt_ssl":"aaPanel SSL",
		"lets_ssl":"Let's Encrypt 免费证书",
		"other":"其他",
		"other_ssl":"其他证书",
		"use_other_ssl":"使用其他证书",
		"ssl_help_1": "此站点的SSL未设置，如果需要，请切换选项卡以申请SSL证书.<br><p style='color:red;'>禁用SSL后，请确保在访问网站之前清除浏览器缓存.</p>",
		"ssl_help_2": "自动生成的 Let's Encrypt 免费证书；",
		"ssl_help_3": "如果您有自己的SSL证书, 请切换到 [other certificate] 选项卡进行添加",
		"ssl_key":"私钥(KEY)",
		"ssl_crt":"证书(CRT/PEM)",
		"ssl_close":"关闭SSL",
        ...
        "specify_subdir": "一些程序需要指定辅助目录作为工作目录<br>&nbsp; &nbsp; &nbsp;例如，ThinkPHP5，Laravel，选择你的工作目录，点击保存",
        "independent_storage": "If trun on, the session file will be stored in a separate folder, not shared with other sites.",
        "pass_visit": "密码权限 Password access",
        "session_off": "会话隔离 Session isolation",
		...
		"proxy_tips3": "发送域名：将域名添加到请求头中并传递给代理服务器",
		"proxy_tips4": "内容替换：Nginx 独有，用指定内容替换网站内容",
        "proxy_tips01": "Proxy dir: When accessing this dir, the content of the target URL will be displayed (Advanced Needs)",
        "proxy_tips02": "Target URL:Fill in the website you need to proxy, the target URL must be an accessible URL",
        "proxy_tips03": "Sent Domain: Add the domain name to the request header and pass it to the proxy server",
        "proxy_tips04": "Content replacement: Nginx exclusive, replace the content of the website with the specified content",
		"create_proxy": "创建反向代理",
		"modify_proxy": "修改反向代理",
		"open_proxy": "启用代理",
		"proxy_adv": "高级功能",
        ...
        "deploy_success_cret": "注意: ",
        "try_renew_cret": "SSL将在到期日前1个月自动续订",
        "cert_brand": "机构: ",
        "expire_time": "到期时间: ",
        "auth_domain": "认证域名(s): ",
        "ssl_renew": "续订",
        "deploy_success_tips": "<b>已成功部署</b>请在证书过期之前替换新证书",
        "not_deploy_and_save": "<b style=\"color:red;\">当前未部署: </b> 点击[Save]按钮完成此证书的部署",
